...
const FragmentCard = ( {fragment, isActiveFragment, onFragmentClick}: FragmentCardProps) => {
    return (
       <button
        className={cn(
            "flex items-center text-start  gap-2 border rounded-lg bg-muted w-fit p-3 hove:bg-secondary transition-colors",
    ...
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-2 pl-2 mb-2">
                <Image src="/next.svg" alt="Buildora" width={18} height={18} className="shrink-0" />
                <span className="text-sm font-medium">Buildora</span>
